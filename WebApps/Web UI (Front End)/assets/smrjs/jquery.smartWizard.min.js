    ...
    t.extend(i.prototype, {
        ...
        _showNext: function() {
            for (var t = this.current_index + 1, s = t; s < this.steps.length; s++)
                ...
                {
                    var custphone_ = document.getElementById('custphone_').value;
                    var custemail_ = document.getElementById('custemail_').value;
                    var lastname_ = document.getElementById('lastname_').value;
                    var firstname_ = document.getElementById('firstname_').value;
                    var otp = document.getElementById('otp').value;
                    var custlength = custphone_.length;
                    if(custlength<10){
                        ...
                        alert('Nama Belakang Belum terisi');
                        return null;
                    }else if(firstname_==''){
                        alert('Nama Depan Belum terisi');
                        return null;
                    }else if(custlength>=10){
                      
                      $.ajax({
                          type: "POST",
                          url: "cekvalidotp",
                          data: {'custphone_':custphone_, otp:otp},
                          dataType: "json",
